...
func (x *PeerData) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *PeerData) GetVersion() int32 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *PeerData) GetDeleted() bool {
	if x != nil {
		return x.Deleted
	}
	return false
...
func (x *PeerData) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_service_service_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x0d, 0x0a, 0x0b, 0x50, 0x69, 0x6e, 0x67, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x0d, 0x0a, 0x0b, 0x50, 0x6f, 0x6e, 0x67, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x66, 0x0a, 0x08, 0x50, 0x65, 0x65, 0x72, 0x44, 0x61, 0x74,
	...
	,
...
var file_service_service_proto_goTypes = []interface{}{
	...
	(*PongMessage)(nil), // 1: PongMessage
	(*PeerData)(nil),    // 2: PeerData
}
var file_service_service_proto_depIdxs = []int32{
	0, // 0: GossipService.Ping:input_type -> PingMessage
	2, // 1: GossipService.ShareData:input_type -> PeerData
	1, // 2: GossipService.Ping:output_type -> PongMessage
	2, // 3: GossipService.ShareData:output_type -> PeerData
